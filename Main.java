...
import com.mentat.University.dao.*;
import com.mentat.University.exception.LectureExistsException;
import com.mentat.University.exception.PersonExistsException;
import com.mentat.University.exception.UniversityObjectExistanseException;
import com.mentat.University.*;
...
public class Main {
	public static void main(String[] args) throws DAOException, LectureExistsException, PersonExistsException {
		...
		sc.setLectures(sc.extractLecturesByIdAndDate(dateLecture1,(long)2012));
		// then print
		sc.printLecturesToConsole();
